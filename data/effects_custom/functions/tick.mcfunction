...
execute at @a[predicate=colonel:has_spellbook_healing] run function effects_custom:healing_ring
###for testing:
...
###Hail_Of_Arrows
execute as @a[predicate=colonel:has_spellbook_hail_of_arrows, predicate=colonel:is_sneaking] run function effects_custom:hail_of_arrows_ritual
...
execute at @a[predicate=colonel:has_spellbook_shield, scores={shield_cd=120..}] run function effects_custom:shield1
execute at @a[predicate=colonel:has_spellbook_shield, scores={shield_cd=120..}] run function effects_custom:shield2
...
##pixel effects:
execute at @a[predicate=colonel:has_spellbook_teleportation, predicate=colonel:is_sneaking] run function effects_custom:teleporting_pixel
...
###Xray
execute as @a[predicate=colonel:has_spellbook_xray,predicate=!colonel:has_haste] run function effects_custom:xray


###Magic_Missile
execute as @a[predicate=colonel:has_spellbook_magic_missile,predicate=colonel:is_sneaking, scores={magic_missile_cd=0}] run function effects_custom:magic_missile
